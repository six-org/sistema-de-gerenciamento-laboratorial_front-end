    ...
    <div className="w-full h-screen flex flex-col justify-between sticky top-0 p-[1.625rem_1rem] border-r-[1px] border-[#CED2DA]">
      <div>
        ...
        <nav className="flex flex-col gap-[0.625rem] mt-[3rem]">
          ...
          <ItemNavegacaoUser
            title={"Laboratório"}
            href={"/laboratorio"}
            icone={<IoFlaskOutline />}
          />

          <ItemNavegacaoUser
            title={"Calendário"}
            href={"/calendario"}
            icone={<PiCalendarPlusBold />}
          />
          ...
          >
            <span className="w-full flex justify-start h-[4px] rounded-[2px] overflow-hidden bg-[#EFF1F3]">
              <span
                ...
                className="h-full bg-primary-pure flex rounded-[0_2px_2px_0]"
              ></span>
            </span>
      ...
      <div>
        <button
          ...
          className="flex items-center w-fit gap-[.5rem] text-[0.75rem] text-[#71717A] hover:text-error transition-[color] duration-[.3s] linear"
        >
