      ...
      <div className="grid grid-cols-[17rem_1fr_23.75rem]">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col ml-[50px] mt-[2.75rem]">
            <p className="text-[18px] font-semibold text-[#48505E]">
              Rastreio da Amostra
            </p>
            <p className="text-[14px] font-medium text-[#667085]">
              Onde está a sua amostra agora? Veja aqui!
            </p>
            ...
            <div className="w-[1016px] h-[65px] mt-5 flex">
              ...
              <div className="flex w-full">
                {steps.map((step, index) => (
                  <div
                    key={index}
                    className="flex flex-col w-[calc((100%-10px)/8)] h-[65px]"
                  >
                    ...
                    <div className="flex items-center gap-1 p-2 ml-1">
                      <div
                        className={`w-[10px] h-[10px] rounded-full ${
                          step.completed ? "bg-primary-pure" : "bg-[#CED2DA]"
                        }`}
                      ></div>
                      <div
                        className={`w-[95px] h-[2px] rounded-[50px] ${
                          step.completed ? "bg-primary-pure" : "bg-[#CED2DA]"
                        }`}
                      ></div>
                    </div>
          ...
          <div className="ml-[50px] mt-[50px]">
            <p className="text-[18px] font-semibold text-[#48505E] mb-[20px]">
              Dados do Paciente
            </p>
              ...
              <Card className="border-[#E4E7EC] rounded-[16px]">
                <CardContent className="w-[167px] space-y-4 mt-[30px]">
                  <div className="w-[147px] flex flex-col">
                    <p className="text-[#444444] text-[12px] font-semibold">
                      Nome
                    </p>
                  ...
                  <div className="overflow-y-auto h-[350px] w-[266.47px] flex flex-col space-y-5">
                    <div className="flex w-full h-10 items-center">
                      ...
                      <div className="w-[127px] h-10 flex flex-col">
                        <p className="text-[#4B4C4D] text-[14px] font-semibold">
                          Exame-1
                        </p>
                        <p className="text-[#A5A8B4] text-[13px]">
                          15 de jan 2020
                        </p>
                      </div>
