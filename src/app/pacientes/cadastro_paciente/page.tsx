          ...
          <form onSubmit={submitPaciente} className="gap-[24px] mt-[2.75rem]">
            ...
            <div className="gap-[24px]">
              ...
              <div className="grid grid-cols-4 gap-[26px] mt-[1.5rem]">
                <div className="">
                  <label className="font-normal	text-base flex text-grey-700">
                    Nome<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                ...
                <div className="">
                  <label className="font-normal text-base text-grey-700 flex">
                    CPF<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] w-full focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div className="">
                  <label className="font-normal text-base text-grey-700 flex">
                    Data de Nascimento<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] w-full focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div className="">
                  <label className="font-normal text-base text-grey-700 flex">
                    Idade<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] w-full focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div className="">
                  <label className="font-normal text-base text-grey-700 flex">
                    Sexo<p className="text-[#FF0000]">*</p>
                  </label>
                  <Select name="paciente-sexo">
                    ...
                    <SelectContent className="color-white bg-white">
                      <Select_Cadastro_Paciente_Primary
                        value="homem"
                        text="Homem"
                      />
                      <Select_Cadastro_Paciente_Primary
            ...
            <div className="gap-[24px] mt-[2rem]">
              ...
              <div className="grid grid-cols-4 gap-[24px] mt-[1.5rem]">
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Cidade<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Endereço<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Número<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Bairro<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Complemento<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
            ...
            <div className="gap-[24px] mt-[2rem]">
              ...
              <div className="grid grid-cols-4 gap-[24px] mt-[1.5rem]">
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Telefone<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    E-mail<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="email"
            ...
            <div className="gap-[24px] mt-[2rem]">
              ...
              <div className="grid grid-cols-4 gap-[24px] mt-[1.5rem]">
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Tipo Sanguíneo<p className="text-[#FF0000]">*</p>
                  </label>
                ...
                <div>
                  <label className="font-normal	text-base text-grey-700 flex">
                    Peso<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Altura<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Alergias<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Doenças Preexistentes<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure border-[#D0D5DD]"
                    type="text"
                ...
                <div>
                  <label className="font-normal text-base text-grey-700 flex">
                    Medicamentos em Uso<p className="text-[#FF0000]">*</p>
                  </label>
                  <Input
                    className="h-[3rem] focus:outline-primary-pure focus-visible:outline-primary-pure focus-visible:text-primary-pure  border-[#D0D5DD]"
                    type="text"
              ...
              <div className="flex gap-[.625rem] justify-end mt-[1.125rem]">
                ...
                <Link href="/pacientes">
                  <Button
                    type="submit"
                    className="border-2 border-sky-500 text-white bg-primary-pure w-[6.875rem]"
                  >
                    Adicionar
                  </Button>
                </Link>
