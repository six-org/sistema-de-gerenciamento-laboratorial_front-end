    ...
    <>
      <div className="grid grid-cols-[17rem_1fr_23.75rem]">
        ...
        <div className="p-[3.625rem_0.625rem]">
          <Input
            className="text-[#E4E4E7] hover:text-neutral-dark"
            type="text"
            placeholder="Buscar"
          />
          ...
          <div className="mt-[2rem] flex flex-wrapper gap-[1.5rem] justify-between items-center">
            <Card_Resultado
              ...
              numero={18}
              porcentagem={18}
              icone={<LuFileCheck className="h-full w-full text-[#10B978]" />}
            />
            ...
            <Card_Resultado
              ...
              numero={11}
              porcentagem={18}
              icone={<ImSpinner6 className="h-full w-full text-[#4C61CD]" />}
            />
            ...
            <Card_Resultado
              ...
              numero={18}
              porcentagem={18}
              icone={<CgDanger className="h-full w-full text-[#FF5656]" />}
            />
          </div>
          <p className="text-[.875rem] font-normal mt-[.5rem] text-[#344051] ml-[1.5rem]">
            Dados atualizados há{" "}
            <span className="font-medium text-black">45 segundos</span>.
          </p>

          <div className="py-[1.5rem] grid grid-cols-3 gap-[.625rem]">
            <Link href="/pacientes/cadastro_paciente" className="w-full">
              <Button_Lab
                icone={<AiOutlineFileAdd className="mr-2 h-4 w-4" />}
                titulo={"Incluir Atendimento"}
              />
            </Link>

            <Button_Lab
              icone={<FiSave className="mr-2 h-4 w-4" />}
              titulo={"Gerar Relatório"}
            />
            <Link href="/pacientes">
              <Button_Lab
                icone={<FiUsers className="mr-2 h-4 w-4" />}
